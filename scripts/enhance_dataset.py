...
def get_model_instance(model_name):
    # CNNs
    if model_name == 'resnet18': return models.resnet18(weights=None), (3, 224, 224)
    if model_name == 'resnet50': return models.resnet50(weights=None), (3, 224, 224)
    if model_name == 'mobilenet_v2': return models.mobilenet_v2(weights=None), (3, 224, 224)
    if model_name == 'densenet121': return models.densenet121(weights=None), (3, 224, 224)
    if model_name == 'vgg16': return models.vgg16(weights=None), (3, 224, 224)
    if model_name == 'efficientnet_b0': return models.efficientnet_b0(weights=None), (3, 224, 224)
    if model_name == 'regnet_y_400mf': return models.regnet_y_400mf(weights=None), (3, 224, 224)
